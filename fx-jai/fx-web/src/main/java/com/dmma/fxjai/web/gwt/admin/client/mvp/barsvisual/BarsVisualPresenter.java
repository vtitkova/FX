...
public class BarsVisualPresenter implements IPresenter{  
	public static final String PRESENTER_ID    = "barsv";
	...
	private BarsVisualDisplay          display;
	
	public BarsVisualPresenter(){
